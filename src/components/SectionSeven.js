              ...
              <div className="mt-8 pt-6 border-t border-neutral-100">
                <div className="flex flex-col items-center text-center">
                  <div className="flex items-center mb-4">
                    ...
                    <h4 className="font-subheadline font-bold text-xl text-brand-600">30‑Day Money‑Back Guarantee</h4>
                  </div>
                  <p className="text-neutral-600 font-content">
                    Try ARC Courses completely risk‑free. If you don't see the value within 30 days, we'll refund 100% of your purchase—no questions asked.
                  </p>
                </div>
              </div>
            </div>
